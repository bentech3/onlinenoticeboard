...
import { Calendar, Building2, User, AlertTriangle, Paperclip, ChevronRight } from 'lucide-react';
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2">
                {showStatus && (
                  <Badge variant="outline" className={cn('capitalize', statusStyles[notice.status])}>
                    {notice.status}
                  </Badge>
                )}
                {notice.is_urgent && (
                ...
                {notice.priority !== 'normal' && (
                  <Badge variant="outline" className={cn('capitalize', priorityStyles[notice.priority])}>
                    {notice.priority}
                  </Badge>
                )}
                {notice.category && (
